...
//  EventsAppUI2
//
//  Created by Jonathan Villegas on 01/11/2016.
...
#define kLatestKivaLoansURL [NSURL URLWithString:@"https://api.kivaws.org/v1/loans/search.json?status=fundraising"] //2